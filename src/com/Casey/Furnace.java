...
//    };
    ...
    public Furnace(String serviceType, String serviceAddress, String problemDescription, Date date, int furnaceType) {

        super(serviceType, serviceAddress, problemDescription, date);
